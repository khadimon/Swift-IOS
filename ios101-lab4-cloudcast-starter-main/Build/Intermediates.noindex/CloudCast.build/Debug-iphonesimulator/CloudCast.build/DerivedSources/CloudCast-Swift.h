...
#ifndef CLOUDCAST_SWIFT_H
#define CLOUDCAST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CloudCast",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9CloudCast11AppDelegate")
...
SWIFT_CLASS("_TtC9CloudCast22ForecastViewController")
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified windspeedLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified windDirectionLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified dateLabel;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified forecastImageView;
- (void)viewDidLoad;
- (IBAction)didTapBackButton:(UIButton * _Nonnull)sender;
- (IBAction)didTapForwardButton:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC9CloudCast13SceneDelegate")
