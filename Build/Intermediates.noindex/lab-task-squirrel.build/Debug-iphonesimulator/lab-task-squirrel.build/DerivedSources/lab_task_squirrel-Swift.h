...
#ifndef LAB_TASK_SQUIRREL_SWIFT_H
#define LAB_TASK_SQUIRREL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="lab_task_squirrel",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC17lab_task_squirrel11AppDelegate")
...
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified completedImageView;
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified descriptionField;
- (void)viewDidLoad;
- (IBAction)didTapDoneButton:(id _Nonnull)sender;
- (IBAction)didTapCancelButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC17lab_task_squirrel24TaskDetailViewController")
@interface TaskDetailViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)didTapAttachPhotoButton:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified emptyStateLabel;
- (void)viewDidLoad;
...
@interface TaskListViewController (SWIFT_EXTENSION(lab_task_squirrel)) <UITableViewDataSource>
